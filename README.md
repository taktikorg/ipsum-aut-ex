...
[![Version badge](https://badgen.net/github/release/PLhery/node-@taktikorg/ipsum-aut-ex)](https://github.com/PLhery/node-@taktikorg/ipsum-aut-ex)
[![Checks badge](https://github.com/PLhery/node-@taktikorg/ipsum-aut-ex/actions/workflows/CI.yml/badge.svg)](https://github.com/PLhery/node-@taktikorg/ipsum-aut-ex/actions/workflows/CI.yml)
[![Package size badge](https://badgen.net/bundlephobia/minzip/@taktikorg/ipsum-aut-ex)](https://bundlephobia.com/package/@taktikorg/ipsum-aut-ex)
...
For a more detailed explanation, please see [this discussion](https://github.com/PLhery/node-@taktikorg/ipsum-aut-ex/discussions/459).
...
```bash
yarn add @taktikorg/ipsum-aut-ex
# or
npm i @taktikorg/ipsum-aut-ex
```

Here's a quick example of usage:

```ts
import { TwitterApi } from '@taktikorg/ipsum-aut-ex';
...
`@taktikorg/ipsum-aut-ex` is meant to provide full endpoint wrapping, from method name to response data,
...
| -------------- | -------------- | ---------------- | ------------- | ---------- | --------------- | -------------:|  -------------:|
| @taktikorg/ipsum-aut-ex | v1.1, v2, labs | ✅               | ✅             | ✅         | 0               | ~23 kB      | [![@taktikorg/ipsum-aut-ex install size badge](https://badgen.net/packagephobia/install/@taktikorg/ipsum-aut-ex)](https://packagephobia.com/result?p=@taktikorg/ipsum-aut-ex) |
...
Here's everything `@taktikorg/ipsum-aut-ex` can do:
...
Learn how to use the full potential of `@taktikorg/ipsum-aut-ex`.
...
- Deep diving into requests
  ...
  - [Master `@taktikorg/ipsum-aut-ex` paginators](./doc/paginators.md)
  - [Discover available helpers](./doc/helpers.md)

## Plugins

Official plugins for `@taktikorg/ipsum-aut-ex`:
- [`@@taktikorg/ipsum-aut-ex/plugin-token-refresher`](https://www.npmjs.com/package/@@taktikorg/ipsum-aut-ex/plugin-token-refresher): Handle OAuth 2.0 (user-context) token refreshing for you
- [`@@taktikorg/ipsum-aut-ex/plugin-rate-limit`](https://www.npmjs.com/package/@@taktikorg/ipsum-aut-ex/plugin-rate-limit): Access and store automatically rate limit data
- [`@@taktikorg/ipsum-aut-ex/plugin-cache-redis`](https://www.npmjs.com/package/@@taktikorg/ipsum-aut-ex/plugin-cache-redis): Store responses in a Redis store and serve cached responses
